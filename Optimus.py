#This code implements simple functions to control bulbs and few predefined querries
import serial 
import os
import pygame
import glob
...
try:
    esp32 = serial.Serial('COM12', 9600)  # Adjust port and baudrate as needed,for my case my port is COM12
